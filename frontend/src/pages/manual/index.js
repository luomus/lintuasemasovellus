  ...
  return (
    <div>
      ...
      <Paper className={classes.paper}>
        ...
        <br /><br />
        Sovelluksen listausnäkymät näyttävät tietoa ainoastaan käyttäjän valitsemalta lintuasemalta, ja käyttäjän lisäämät havainnot ja päivät tallennetaan kyseiselle lintuasemalle. Ensimmäisellä kirjautumiskerralla käyttäjälle näytetään valikko, josta käyttäjä valitsee lintuaseman, jonka tietoja käyttäjä haluaa käyttää. Käyttäjä voi myöhemmin vaihtaa lintuasemaa sovelluksen oikeasta yläkulmasta.
        <br />
        <br />
        ...
        <br />
        Sovelluksen etusivulta löytyy päivä- ja havaintotietojen lisäämistä varten lomake. Käyttäjä valitsee kalenterista tai kirjoittaa päivämäärän jolle havaintojaksot lisätään. Oletuksena sovelluksessa on valittuna kuluvan päivän tiedot.
        <br /> <br />Jos päivä löytyy jo tietokannasta, sovellus näyttää kyseiselle päivälle tallennetut havainnoijat, kommentit, havaintoaktiivisuuden ja pyydystiedot. Käyttäjä voi halutessaan päivittää nämä mieleisikseen. Kommentti-, havaintoaktiivisuus- ja pyydystiedot on oletuksena piilotettu, mutta ne saa avattua klikkaamalla niiden otsikkoa.
        <br /> <br />Jos päivää ei ole lisätty tietokantaan aiemmin, uusi päivä luodaan. Käyttäjän tulee kirjoittaa päivälle havainnoija(t). Kommenttikenttä sekä havaintoaktiivisuus- ja pyydystiedot ovat vapaaehtoisia. Havaintoaktiivisuus- ja pyydystiedot ovat lintuasemakohtaisia.
        ...
        <br />
        <br />
        Havainnot kirjataan siis aina kahden kellonajan väliin, ja nämä kellonajat toimivat havaintojakson alku- ja loppuaikoina. Jos uusi havaintojakso alkaa heti edellisen jakson päätyttyä, ei aloitusaikaa tarvitse kirjoittaa uudelleen. Esimerkissä kello 12-13 ei ole ollut havaintoja, joten kyseisen havaintojakson voi jättää tyhjäksi. Tyhjän havaintojakson voi kirjata myös kirjoittamalla <em>tauko</em> - tällöin kyseiselle havaintojaksolle ei voi kirjata varsinaisia havaintoja.
        <br /><br />
        Jos pikakirjoituslomakkeessa on virheitä, sovellus ilmoittaa tästä keltaisella varoitusikkunalla ja pyytää tarkistamaan pikakirjoituksen oikeellisuuden. Varoitusikkunassa kerrotaan, millaisen virheen sovellus pikakirjoituksessa havaitsi. Muiden kenttien virheistä ilmoitetaan kyseisen kentän yhteydessä punaisella varoitusvärillä. Tallenna-nappi aktivoituu painettavaksi, kun havaintolomakkeessa ei ole virheitä ja vaaditut kentät on täytetty. Napin painalluksen myötä päivä ja siihen liittyvät tiedot tallentuvat tietokantaan.
        <br /><br />
